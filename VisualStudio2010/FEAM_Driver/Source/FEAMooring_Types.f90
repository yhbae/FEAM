...
IF ( ALLOCATED( SrcOtherStateData%Line_Tangent ) ) THEN
  i1 = SIZE(SrcOtherStateData%Line_Tangent,1)
  i2 = SIZE(SrcOtherStateData%Line_Tangent,2)
  i3 = SIZE(SrcOtherStateData%Line_Tangent,3)
  IF (.NOT.ALLOCATED(DstOtherStateData%Line_Tangent)) ALLOCATE(DstOtherStateData%Line_Tangent(i1,i2,i3))
...
! 
  ...
  IF ( ALLOCATED(OtherStateData%Line_Tangent) ) DEALLOCATE(OtherStateData%Line_Tangent)
