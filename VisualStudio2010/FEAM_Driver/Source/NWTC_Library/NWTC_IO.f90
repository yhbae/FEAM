...
!
!**********************************************************************************************************************************
! File last committed: $Date: 2013-10-03 00:24:46 -0600 (Thu, 03 Oct 2013) $
...
!=======================================================================
   SUBROUTINE DLLTypePack( InData, ReKiBuf, DbKiBuf, IntKiBuf, ErrStat, ErrMsg, SizeOnly )
      ...
      INTEGER(ReKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
...
!=======================================================================
   SUBROUTINE DLLTypeUnPack( InData, ReKiBuf, DbKiBuf, IntKiBuf, ErrStat, ErrMsg )
      ...
      INTEGER(ReKi),   ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
